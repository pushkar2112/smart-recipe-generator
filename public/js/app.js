...
function populateChecklist(items) {
  ...
  function displayRecipes(recipes, ingredients, dietaryPreferences, allergyPreferences) {
    ...
    recipes.forEach((recipe) => {
      ...
      button.onclick = function() {
        selectRecipe(recipe.title, ingredients, dietaryPreferences, allergyPreferences);
      };
  ...
  async function selectRecipe(recipeName, ingredients, dietaryPreferences, allergyPreferences) {
    toggleLoader(true);
